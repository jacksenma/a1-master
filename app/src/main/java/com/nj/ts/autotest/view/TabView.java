package com.nj.ts.autotest.view;
...
import com.nj.ts.autotest.util.TabViewUtil;
...
public class TabView extends RelativeLayout {
    ...
    /**
     * the Item selected background,default is symbol gray
     */
    private Drawable mItemSelDrawable;
    /**
     * the Item unselected background,default is white
     */
    private Drawable mItemUnSelDrawable;
    /**
    ...
    private void initDefaultAttrs(Context context) {
        mItemSelDrawable = context.getDrawable(R.drawable.tab_item_sel_bg);
        mItemUnSelDrawable = context.getDrawable(R.drawable.tab_item_bg);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.TabView_tab_itemSelBackground) {
            mItemSelDrawable = typedArray.getDrawable(attr);
        } else if (attr == R.styleable.TabView_tab_itemUnSelBackground) {
            mItemUnSelDrawable = typedArray.getDrawable(attr);
    ...
    private void initTabChildView() {
        ...
        mModuleList = new ArrayList<TextView>();
        ...
        for (int i = 0; i < mTabViewChildList.size(); i++) {
            ...
            tabChild.setBackground(mItemUnSelDrawable);
            if (mTabViewDefaultPosition >= mTabViewChildList.size()) {
                if (i == 0) {
                    imageview.setImageResource(t.getImageViewSelIcon());
                    textview.setText(t.getTextViewText());
                    tabChild.setBackground(mItemSelDrawable);
                }
            } else {
    ...
    public void chooseModule(int position) {
        mFromInnerClick = true;
        tabview.getChildAt(position).callOnClick();
    }
    ...
    public List<TextView> getModuleList() {
        return mModuleList;
    }
    ...
    public void setItemSelectedBg(Drawable drawable) {
        this.mItemSelDrawable = drawable;
    }

    public void setItemUnSelectedBg(Drawable drawable) {
        this.mItemUnSelDrawable = drawable;
    }
